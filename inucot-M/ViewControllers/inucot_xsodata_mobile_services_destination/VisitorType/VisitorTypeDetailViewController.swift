...
class VisitorTypeDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    var v2: V2<OnlineODataProvider>!
    private var validity = [String: Bool]()
    var allowsEditableCells = false

    private var _entity: VisitorType?
    var entity: VisitorType {
        get {
            if self._entity == nil {
    ...
    private let logger = Logger.shared(named: "VisitorTypeMasterViewControllerLogger")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "updateEntity" {
            ...
            let detailViewController = dest.viewControllers[0] as! VisitorTypeDetailViewController
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            return self.cellForId(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: VisitorType.id)
        case 1:
            return self.cellForFirstName(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: VisitorType.firstName)
        case 2:
            return self.cellForLastName(tableView: tableView, indexPath: indexPath, currentEntity: self.entity, property: VisitorType.lastName)
        case 3:
        ...
        case 3:
            if !self.entity.isNew {
                ...
                func loadProperty(_ completionHandler: @escaping ([VisitType]?, Error?) -> Void) {
                    self.v2.loadProperty(VisitorType.visits, into: self.entity) { error in
    ...
    private func cellForId(tableView: UITableView, indexPath: IndexPath, currentEntity: VisitorType, property: Property) -> UITableViewCell {
        var value = ""
    ...
    private func cellForFirstName(tableView: UITableView, indexPath: IndexPath, currentEntity: VisitorType, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if VisitorType.firstName.isOptional || newValue != "" {
    ...
    private func cellForLastName(tableView: UITableView, indexPath: IndexPath, currentEntity: VisitorType, property: Property) -> UITableViewCell {
        var value = ""
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: self.entity, property: property, value: value, editingIsAllowed: allowsEditableCells, changeHandler: { (newValue: String) -> Bool in
            ...
            if newValue.isEmpty {
                ...
                if VisitorType.lastName.isOptional || newValue != "" {
    ...
    func createEntityWithDefaultValues() -> VisitorType {
        let newEntity = VisitorType()
...
extension VisitorTypeDetailViewController: Inucot_xsodata_mobile_services_destinationEntityUpdaterDelegate {
    func entityHasChanged(_ entityValue: EntityValue?) {
        if let entity = entityValue {
            let currentEntity = entity as! VisitorType
